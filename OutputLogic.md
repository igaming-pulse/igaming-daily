...
```mermaid
flowchart TD
  X["取得一則（單一來源）"] --> D{"主來源發布日期<br/>含年份且在窗內？"}
  D -- 否 --> DX["視為舊聞 · 剔除並遞補"]
  D -- 是 --> Y["找 ≥1 個獨立來源佐證"]
