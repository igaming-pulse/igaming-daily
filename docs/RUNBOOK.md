...
- **Firecrawl 額度** 1,125 credits／月，每月 14 日重置。現行設定一次日報 **≤ 30 credits**（輪掃 8 ＋ 其他 ≤ 22），一個月約 **900**，額度內但餘裕只剩兩成。
  ⚠️ **兩台機器共用同一把金鑰，額度是共吃的。** 併行期（舊環境 ≤45 ＋ 新環境 ≤30 ≈ 75／天）撐不過一個週期，所以**併行期必須短**，比對 1–2 天就要定切換日。
